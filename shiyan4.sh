...
# 检测区
##
#使用方法 yum install wget vim -y && wget -N --no-check-certificate -q -O install.sh "https://raw.githubusercontent.com/jth445600/hello-world/master/wordpress-v2ray" && chmod +x install.sh && bash install.sh
##
blue(){
...
selectCoreInstall(){
    ...
    echoContent red "\n=============================================================="
    echoContent yellow "开始安装Xray-core+wordpress"
    echoContent red "=============================================================="
    xrayCoreInstall
}
